...
public class ShowUserControllerRoles2Test extends ShowUserControllerTestBase {
  ...
  @Test
  @DisplayName(
    "Payment details is not returned, when session user has role - technical."
  )
  public void test11() {
  ...
  @Test
  @DisplayName(
    "Legal name is returned successfully, when session user has role - contract."
  )
  public void test12() {
  ...
  @Test
  @DisplayName(
    "BalanceInCents is not returned, when session user has role - contract."
  )
  public void test13() {
    AuthenticatedUserServiceStubs
        .kodekonveyorContract(authenticatedUserService);
  ...
  @Test
  @DisplayName(
    "LegalForm is returned successfully, when session user has role - contract."
  )
  public void test14() {
    AuthenticatedUserServiceStubs
        .kodekonveyorContract(authenticatedUserService);
  ...
  @Test
  @DisplayName(
    "LegalAddress is returned successfully, when session user has role - contract."
  )
  public void test15() {
    AuthenticatedUserServiceStubs
        .kodekonveyorContract(authenticatedUserService);
  ...
  @Test
  @DisplayName(
    "IsTermsAccepted is returned successfully, when session user has role - contract."
  )
  public void test16() {
    AuthenticatedUserServiceStubs
        .kodekonveyorContract(authenticatedUserService);
  ...
  @Test
  @DisplayName(
    "Payment details are returned successfully, when session user has role - contract."
  )
  public void test17() {
    AuthenticatedUserServiceStubs
        .kodekonveyorContract(authenticatedUserService);
  ...
  @Test
  @DisplayName(
    "PersonalName is returned successfully, when session user has role - contract."
  )
  public void test18() {
    AuthenticatedUserServiceStubs
        .kodekonveyorContract(authenticatedUserService);
  ...
  @Test
  @DisplayName(
    "Email is returned successfully, when session user has role - contract."
  )
  public void test19() {
    AuthenticatedUserServiceStubs
        .kodekonveyorContract(authenticatedUserService);
  ...
  @Test
  @DisplayName(
    "Legal name is returned successfully, when session user is itself input."
  )
  public void test20() {
